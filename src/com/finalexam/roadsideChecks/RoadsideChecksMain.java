package com.finalexam.roadsideChecks;
import com.finalexam.common.GeneralFileReader;
import com.finalexam.common.GeneralFileWriter;
...
public class RoadsideChecksMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralFileReader reader =
                new GeneralFileReader("resources/roadSideChecks/jarmu-1.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("resources/roadSideChecks/vizsgalt-1.txt");
