...
public class VigenereTableMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("resources/vigenere_table/Vtabla.dat");
        ...
        GeneralFileWriter writer  = new GeneralFileWriter("lessons/resources/vigenere_table/kodolt.dat");
