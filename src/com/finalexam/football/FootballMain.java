...
public class FootballMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("lessons/resources/football/meccs.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("lessons/resources/football/stat.txt");
