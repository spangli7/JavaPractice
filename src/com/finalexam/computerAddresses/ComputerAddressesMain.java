...
public class ComputerAddressesMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("resources/computerAdresses/ip.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("lessons/resources/computerAdresses/sok.txt");
