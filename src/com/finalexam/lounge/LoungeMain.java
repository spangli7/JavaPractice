...
public class LoungeMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("resources/lounge/ajto-1.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("resources/lounge/athaladas-1.txt");
