...
public class RoadsideChecksMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralFileReader reader =
                new GeneralFileReader("src/main/resources/roadSideChecks/jarmu-1.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/roadSideChecks/vizsgalt-1.txt");
