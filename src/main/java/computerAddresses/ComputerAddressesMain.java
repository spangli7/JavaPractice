...
public class ComputerAddressesMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("src/main/resources/computerAddresses/ip.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/computerAddresses/sok.txt");
