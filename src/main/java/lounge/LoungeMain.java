...
public class LoungeMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("src/main/resources/lounge/ajto-1.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/lounge/athaladas-1.txt");
