...
public class FootballMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("src/main/resources/football/meccs.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/football/stat.txt");
