...
public class StreetMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("src/main/resources/fence/kerites.txt");
        ...
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/fence/utcakép.txt");
