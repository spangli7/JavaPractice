...
public class LotteryMain {
    ...
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("src/main/resources/lottery/lottosz.dat");
        ...
        // 7.task
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/lottery/lotto52.dat");
        ...
        // 8.task
        System.out.println("\n8.task");
        GeneralFileReader newReader = new GeneralFileReader("src/main/resources/lottery/lotto52.dat");
