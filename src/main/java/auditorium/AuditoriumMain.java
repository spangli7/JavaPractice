...
public class AuditoriumMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader booked = new GeneralFileReader("src/main/resources/auditorium/foglaltsag.txt");
        GeneralFileReader category = new GeneralFileReader("src/main/resources/auditorium/kategoria-4.txt");
        ...
        // 7.task
        GeneralFileWriter writer = new GeneralFileWriter("src/main/resources/auditorium/szabad-4.txt");
