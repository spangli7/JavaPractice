...
public class VigenereTableMain {
    public static void main(String[] args) {
        ...
        GeneralFileReader reader = new GeneralFileReader("src/main/resources/vigenere_table/Vtabla.dat");
        ...
        GeneralFileWriter writer  = new GeneralFileWriter("src/main/resources/vigenere_table/kodolt.dat");
